      ...
      <Router>
        <Scene key="root">
          <Scene
            ...
            initial={true}
          />
          <Scene key="NewUser" hideNavBar component={NewUser} title="NewUser" />
          <Scene
            key="loginuser"
            hideNavBar
            component={LoginUser}
          ...
          <Scene
            key="meiosdepagt"
            hideNavBar
            component={MeiosdePagt}
            title="MeiosdePagt"
          />
          <Scene
            key="delmeiosdepagt"
            hideNavBar
            component={DelMeiosdePagt}
            title="DelMeiosdePagt"
          />
          <Scene
            key="addmeiosdepagt"
            hideNavBar
            component={AddMeiosdePagt}
            title="AddMeiosdePagt"
          />
